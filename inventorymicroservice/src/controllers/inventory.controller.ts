...
export class InventoryController {
  ...
  async create(
    ...
    //this.inventoryRepository.find({where: {name: });
  ...
  async count(
    @param.query.object('where', getWhereSchemaFor(Inventory))
    where?: Where<Inventory>,
  ): Promise<Count> {
  ...
  async find(
    @param.query.object('filter', getFilterSchemaFor(Inventory))
